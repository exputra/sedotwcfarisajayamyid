...
const HeroNew = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center pt-20 pb-12 sm:pt-24 sm:pb-16 lg:pt-32 lg:pb-24">
      {/* Background Layer */}
      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-12">
        <div className="max-w-2xl flex flex-col gap-4 sm:gap-5 lg:gap-6">
          {/* Badge */}
          <motion.div
          ...
          <motion.p
            ...
            className="text-base sm:text-lg md:text-xl text-slate-600 leading-relaxed max-w-xl font-medium mt-2"
          >
          ...
          <motion.div
            ...
            className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4 mt-4"
          >
            <a 
              id="hero-call-button"
