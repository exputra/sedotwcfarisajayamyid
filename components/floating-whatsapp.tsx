...
const FloatingWhatsApp = () => {
  const handleClick = () => {
    window.open(
      `${siteConfig.links.whatsapp}&text=${encodeURIComponent('Halo Farisa Jaya Sedot WC')}`,
      '_blank',
      'noopener,noreferrer'
    );
  };
  ...
  return (
    <motion.a
      ...
      href={`${siteConfig.links.whatsapp}&text=${encodeURIComponent('Halo Farisa Jaya Sedot WC')}`}
      target="_blank"
